  ...
  <header class="header">
    <div class="container">
      <div class="header__top">
        <?php the_custom_logo(); ?>
        <a class="phone" href="tel:+<?php the_field('phone-attr');?>"><?php the_field('phone');?></a>
      </div>
      <div class="header__content">
        ...
        <img data-wow-delay="2s" class="header__images wow animate__fadeInUpBig" src="<?php the_field('img-car-general')?>"
          alt="ford mustang">
      </div>
    </div>
  </header>