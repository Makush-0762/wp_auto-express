    ...
    <div class="container">
      ...
      <div class="services__inner">
        <div class="services__content">
          <?php the_field('text-servives');?>
        </div>
          <?php the_field('item-survive');?>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="contacts__inner">
        <div class="contacts__info">
          ...
          <ul class="contacts__list">
            ...
            <li class="contacts__item">
              ...
              <p class="contacts__item-text">
                <a href="tel:+<?php the_field('phone-attr');?>"><?php the_field('phone');?></a>
              </p>
            </li>
          </ul>
        </div>
        <form class="contacts__form">
          ...
          <?php echo do_shortcode('[contact-form-7 id="a905705" title="Контактна форма 1"]')?>
        </form>
      </div>
    </div>
  </section>
